...
export class RadialTreeComponent implements OnInit {
  ...
  setPropsRecursive(data: any, searchValue: any, searchProp: any, newValue: any, newProp: any, pathObjects) {
    ...
    for (let i = 0; i < data.length; i++) {
      ...
      if (foundValue == searchValue) {
        ...
        // this.setPropsRecursive(data[i]["parent"], "", "name")

        this.walk(data[i]["parent"])
        ...
        //   // if object["parent"] = 
        //   // console.log("~ object[newProp]", object)
        //   console.log("~  ---------------------------------------")
        // }
        // data[i][newProp] = newValue
        // pathObjects.push(data[i])
        ...
        this.setPropsRecursive(data[i]["children"], searchValue, searchProp, newValue, newProp, pathObjects);
      }
    }
  }
