...
import 'lodash';
declare var _: any;
import { paintBranch, turnLabelRedAndBold, toggleLabel } from "./radial-tree-nodes-styling"
import { defaultOptions } from "./options/default-options"
import { initOptions } from "./options/init-options"
import { labelStyleInitRoot, lineStyleInitRoot, itemStyleInitRoot } from "./radial-tree-style-templates"
...
export class RadialTreeComponent implements OnInit {
  ...
  onLighthouseSelected(flag_id: number) {
    console.log("~  -------------")
    console.log("~ event", event)
    console.log("~  -------------")

    // TODO: Catch errors
    this.traverse(this.data, flag_id, "flag_LT", node => {
  ...
  onChangeLayer(event) {
    console.log("~  -------------")
    console.log("~ oncChangeNumberOfLayers", event)
    console.log("~  -------------")
  }
